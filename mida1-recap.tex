...
\begin{enumerate}
	...
	\item \question{Consider a stationary process with covariance function \boldmath{$\gamma(\tau)$} and \boldmath{$\Gamma(\omega)$} spectrum}{$\gamma(1)=0)$}{$\gamma(1)=4$}{$\gamma(-1)=4$}{$\gamma(-1)=0$}
